...
var file_kitchen_sink_proto_rawDesc = []byte{
	...
	0x67, 0x49, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x22, 0xbc, 0x02, 0x0a, 0x15, 0x45, 0x78, 0x65, 0x63,
	...
	,
...
var file_kitchen_sink_proto_msgTypes = make([]protoimpl.MessageInfo, 55)
var file_kitchen_sink_proto_goTypes = []interface{}{
	...
	(*v1.Payload)(nil),                // 63: temporal.api.common.v1.Payload
	(*v1.RetryPolicy)(nil),            // 64: temporal.api.common.v1.RetryPolicy
	(*v1.Priority)(nil),               // 65: temporal.api.common.v1.Priority
	(v11.WorkflowIdReusePolicy)(0),    // 66: temporal.api.enums.v1.WorkflowIdReusePolicy
	(*v1.Memo)(nil),                   // 67: temporal.api.common.v1.Memo
	(*v12.Failure)(nil),               // 68: temporal.api.failure.v1.Failure
	(v11.WorkflowIdConflictPolicy)(0), // 69: temporal.api.enums.v1.WorkflowIdConflictPolicy
}
var file_kitchen_sink_proto_depIdxs = []int32{
	...
	60,  // 5: temporal.omes.kitchen_sink.ClientActionSet.wait_at_end:type_name -> google.protobuf.Duration
	...
	61,  // 22: temporal.omes.kitchen_sink.DoQuery.report_state:type_name -> temporal.api.common.v1.Payloads
	...
	62,  // 27: temporal.omes.kitchen_sink.DoActionsUpdate.reject_me:type_name -> google.protobuf.Empty
	63,  // 28: temporal.omes.kitchen_sink.HandlerInvocation.args:type_name -> temporal.api.common.v1.Payload
	...
	62,  // 48: temporal.omes.kitchen_sink.AwaitableChoice.wait_finish:type_name -> google.protobuf.Empty
	...
	62,  // 52: temporal.omes.kitchen_sink.AwaitableChoice.cancel_after_completed:type_name -> google.protobuf.Empty
	...
	60,  // 56: temporal.omes.kitchen_sink.ExecuteActivityAction.delay:type_name -> google.protobuf.Duration
	62,  // 57: temporal.omes.kitchen_sink.ExecuteActivityAction.noop:type_name -> google.protobuf.Empty
	...
	60,  // 65: temporal.omes.kitchen_sink.ExecuteActivityAction.schedule_to_close_timeout:type_name -> google.protobuf.Duration
	60,  // 66: temporal.omes.kitchen_sink.ExecuteActivityAction.schedule_to_start_timeout:type_name -> google.protobuf.Duration
	60,  // 67: temporal.omes.kitchen_sink.ExecuteActivityAction.start_to_close_timeout:type_name -> google.protobuf.Duration
	60,  // 68: temporal.omes.kitchen_sink.ExecuteActivityAction.heartbeat_timeout:type_name -> google.protobuf.Duration
	64,  // 69: temporal.omes.kitchen_sink.ExecuteActivityAction.retry_policy:type_name -> temporal.api.common.v1.RetryPolicy
	62,  // 70: temporal.omes.kitchen_sink.ExecuteActivityAction.is_local:type_name -> google.protobuf.Empty
	...
	65,  // 73: temporal.omes.kitchen_sink.ExecuteActivityAction.priority:type_name -> temporal.api.common.v1.Priority
	63,  // 74: temporal.omes.kitchen_sink.ExecuteChildWorkflowAction.input:type_name -> temporal.api.common.v1.Payload
	60,  // 75: temporal.omes.kitchen_sink.ExecuteChildWorkflowAction.workflow_execution_timeout:type_name -> google.protobuf.Duration
	60,  // 76: temporal.omes.kitchen_sink.ExecuteChildWorkflowAction.workflow_run_timeout:type_name -> google.protobuf.Duration
	60,  // 77: temporal.omes.kitchen_sink.ExecuteChildWorkflowAction.workflow_task_timeout:type_name -> google.protobuf.Duration
	...
	66,  // 79: temporal.omes.kitchen_sink.ExecuteChildWorkflowAction.workflow_id_reuse_policy:type_name -> temporal.api.enums.v1.WorkflowIdReusePolicy
	64,  // 80: temporal.omes.kitchen_sink.ExecuteChildWorkflowAction.retry_policy:type_name -> temporal.api.common.v1.RetryPolicy
	...
	63,  // 87: temporal.omes.kitchen_sink.SendSignalAction.args:type_name -> temporal.api.common.v1.Payload
	...
	67,  // 92: temporal.omes.kitchen_sink.UpsertMemoAction.upserted_memo:type_name -> temporal.api.common.v1.Memo
	63,  // 93: temporal.omes.kitchen_sink.ReturnResultAction.return_this:type_name -> temporal.api.common.v1.Payload
	68,  // 94: temporal.omes.kitchen_sink.ReturnErrorAction.failure:type_name -> temporal.api.failure.v1.Failure
	63,  // 95: temporal.omes.kitchen_sink.ContinueAsNewAction.arguments:type_name -> temporal.api.common.v1.Payload
	60,  // 96: temporal.omes.kitchen_sink.ContinueAsNewAction.workflow_run_timeout:type_name -> google.protobuf.Duration
	60,  // 97: temporal.omes.kitchen_sink.ContinueAsNewAction.workflow_task_timeout:type_name -> google.protobuf.Duration
	...
	64,  // 101: temporal.omes.kitchen_sink.ContinueAsNewAction.retry_policy:type_name -> temporal.api.common.v1.RetryPolicy
	...
	23,  // 106: temporal.omes.kitchen_sink.ExecuteNexusOperation.awaitable_choice:type_name -> temporal.omes.kitchen_sink.AwaitableChoice
	63,  // 107: temporal.omes.kitchen_sink.ExecuteNexusOperation.expected_output:type_name -> temporal.api.common.v1.Payload
	39,  // 108: temporal.omes.kitchen_sink.NexusOperationRequest.workflow_action:type_name -> temporal.omes.kitchen_sink.NexusWorkflowAction
