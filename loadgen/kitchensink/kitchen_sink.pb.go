...
type ExecuteActivityAction struct {
	...
	//	*ExecuteActivityAction_Standalone
...
func (x *ExecuteActivityAction) GetRetryableError() *ExecuteActivityAction_RetryableErrorActivity {
	if x != nil {
		if x, ok := x.ActivityType.(*ExecuteActivityAction_RetryableError); ok {
...
func (x *ExecuteActivityAction) GetTimeout() *ExecuteActivityAction_TimeoutActivity {
	if x != nil {
		if x, ok := x.ActivityType.(*ExecuteActivityAction_Timeout); ok {
			return x.Timeout
		}
	}
	return nil
...
func (x *ExecuteActivityAction) GetHeartbeat() *ExecuteActivityAction_HeartbeatTimeoutActivity {
	if x != nil {
		if x, ok := x.ActivityType.(*ExecuteActivityAction_Heartbeat); ok {
			return x.Heartbeat
		}
	}
	return nil
...
func (x *ExecuteActivityAction) GetStandalone() *ExecuteActivityAction_StandaloneActivity {
	if x != nil {
		if x, ok := x.ActivityType.(*ExecuteActivityAction_Standalone); ok {
			return x.Standalone
		}
	}
	return nil
...
type ExecuteActivityAction_Standalone struct {
	// There must be an activity named `standalone` which invokes another activity via standalone activity API
	Standalone *ExecuteActivityAction_StandaloneActivity `protobuf:"bytes,23,opt,name=standalone,proto3,oneof"`
}
...
func (*ExecuteActivityAction_Standalone) isExecuteActivityAction_ActivityType() {}
...
// Activity that invokes another activity via the standalone activity API
// (StartActivityExecution + PollActivityExecution). This tests the standalone
// activity feature while reusing existing activity implementations.
type ExecuteActivityAction_StandaloneActivity struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The activity type to invoke as a standalone activity (e.g., "payload", "noop", "delay")
	ActivityType string `protobuf:"bytes,1,opt,name=activity_type,json=activityType,proto3" json:"activity_type,omitempty"`
	// For payload activity: bytes to receive as input
	BytesToReceive int32 `protobuf:"varint,2,opt,name=bytes_to_receive,json=bytesToReceive,proto3" json:"bytes_to_receive,omitempty"`
	// For payload activity: bytes to return as output
	BytesToReturn int32 `protobuf:"varint,3,opt,name=bytes_to_return,json=bytesToReturn,proto3" json:"bytes_to_return,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ExecuteActivityAction_StandaloneActivity) Reset() {
	*x = ExecuteActivityAction_StandaloneActivity{}
	mi := &file_kitchen_sink_proto_msgTypes[38]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ExecuteActivityAction_StandaloneActivity) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ExecuteActivityAction_StandaloneActivity) ProtoMessage() {}

func (x *ExecuteActivityAction_StandaloneActivity) ProtoReflect() protoreflect.Message {
	mi := &file_kitchen_sink_proto_msgTypes[38]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ExecuteActivityAction_StandaloneActivity.ProtoReflect.Descriptor instead.
func (*ExecuteActivityAction_StandaloneActivity) Descriptor() ([]byte, []int) {
	return file_kitchen_sink_proto_rawDescGZIP(), []int{16, 7}
}

func (x *ExecuteActivityAction_StandaloneActivity) GetActivityType() string {
	if x != nil {
		return x.ActivityType
	}
	return ""
...
func (x *ExecuteActivityAction_StandaloneActivity) GetBytesToReceive() int32 {
	if x != nil {
		return x.BytesToReceive
	}
	return 0
...
func (x *ExecuteActivityAction_StandaloneActivity) GetBytesToReturn() int32 {
	if x != nil {
		return x.BytesToReturn
	}
	return 0
...
const file_kitchen_sink_proto_rawDesc = "" +
	...
	"\n" +
	"with_start\x18\x03 \x01(\bR\twithStart\x1a\xd7\x01\n" +
	"\x0fDoSignalActions\x12F\n" +
	"\n" +
	"do_actions\x18\x01 \x01(\v2%.temporal.omes.kitchen_sink.ActionSetH\x00R\tdoActions\x12T\n" +
	"\x12do_actions_in_main\x18\x02 \x01(\v2%.temporal.omes.kitchen_sink.ActionSetH\x00R\x0fdoActionsInMain\x12\x1b\n" +
	"\tsignal_id\x18\x03 \x01(\x05R\bsignalIdB\t\n" +
	"\avariantB\t\n" +
	"\avariant\"\xcf\x01\n" +
	"\aDoQuery\x12E\n" +
	...
	"\rWorkflowInput\x12N\n" +
	"\x0finitial_actions\x18\x01 \x03(\v2%.temporal.omes.kitchen_sink.ActionSetR\x0einitialActions\x122\n" +
	"\x15expected_signal_count\x18\x02 \x01(\x05R\x13expectedSignalCount\x12.\n" +
	"\x13expected_signal_ids\x18\x03 \x03(\x05R\x11expectedSignalIds\x12.\n" +
	"\x13received_signal_ids\x18\x04 \x03(\x05R\x11receivedSignalIds\"i\n" +
	"\tActionSet\x12<\n" +
	...
	"\x0fnexus_operation\x18\x0f \x01(\v21.temporal.omes.kitchen_sink.ExecuteNexusOperationH\x00R\x0enexusOperationB\t\n" +
	"\avariant\"\xf7\x02\n" +
	...
	"\x10awaitable_choice\x18\x02 \x01(\v2+.temporal.omes.kitchen_sink.AwaitableChoiceR\x0fawaitableChoice\"\xf3\x17\n" +
	...
	"\x06client\x18\x13 \x01(\v2@.temporal.omes.kitchen_sink.ExecuteActivityAction.ClientActivityH\x00R\x06client\x12s\n" +
	"\x0fretryable_error\x18\x14 \x01(\v2H.temporal.omes.kitchen_sink.ExecuteActivityAction.RetryableErrorActivityH\x00R\x0eretryableError\x12]\n" +
	"\atimeout\x18\x15 \x01(\v2A.temporal.omes.kitchen_sink.ExecuteActivityAction.TimeoutActivityH\x00R\atimeout\x12j\n" +
	"\theartbeat\x18\x16 \x01(\v2J.temporal.omes.kitchen_sink.ExecuteActivityAction.HeartbeatTimeoutActivityH\x00R\theartbeat\x12f\n" +
	"\n" +
	"standalone\x18\x17 \x01(\v2D.temporal.omes.kitchen_sink.ExecuteActivityAction.StandaloneActivityH\x00R\n" +
	"standalone\x12\x1d\n" +
	"\n" +
	...
	"\x16RetryableErrorActivity\x12#\n" +
	"\rfail_attempts\x18\x01 \x01(\x05R\ffailAttempts\x1a\xc2\x01\n" +
	"\x0fTimeoutActivity\x12#\n" +
	"\rfail_attempts\x18\x01 \x01(\x05R\ffailAttempts\x12D\n" +
	"\x10success_duration\x18\x02 \x01(\v2\x19.google.protobuf.DurationR\x0fsuccessDuration\x12D\n" +
	"\x10failure_duration\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\x0ffailureDuration\x1a\xcb\x01\n" +
	"\x18HeartbeatTimeoutActivity\x12#\n" +
	"\rfail_attempts\x18\x01 \x01(\x05R\ffailAttempts\x12D\n" +
	"\x10success_duration\x18\x02 \x01(\v2\x19.google.protobuf.DurationR\x0fsuccessDuration\x12D\n" +
	"\x10failure_duration\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\x0ffailureDuration\x1a\x8b\x01\n" +
	"\x12StandaloneActivity\x12#\n" +
	"\ractivity_type\x18\x01 \x01(\tR\factivityType\x12(\n" +
	"\x10bytes_to_receive\x18\x02 \x01(\x05R\x0ebytesToReceive\x12&\n" +
	"\x0fbytes_to_return\x18\x03 \x01(\x05R\rbytesToReturn\x1a[\n" +
...
var file_kitchen_sink_proto_goTypes = []any{
	...
	(*ExecuteActivityAction_StandaloneActivity)(nil),       // 42: temporal.omes.kitchen_sink.ExecuteActivityAction.StandaloneActivity
...
var file_kitchen_sink_proto_depIdxs = []int32{
	...
	42,  // 54: temporal.omes.kitchen_sink.ExecuteActivityAction.standalone:type_name -> temporal.omes.kitchen_sink.ExecuteActivityAction.StandaloneActivity
	43,  // 55: temporal.omes.kitchen_sink.ExecuteActivityAction.headers:type_name -> temporal.omes.kitchen_sink.ExecuteActivityAction.HeadersEntry
	53,  // 56: temporal.omes.kitchen_sink.ExecuteActivityAction.schedule_to_close_timeout:type_name -> google.protobuf.Duration
	53,  // 57: temporal.omes.kitchen_sink.ExecuteActivityAction.schedule_to_start_timeout:type_name -> google.protobuf.Duration
	53,  // 58: temporal.omes.kitchen_sink.ExecuteActivityAction.start_to_close_timeout:type_name -> google.protobuf.Duration
	53,  // 59: temporal.omes.kitchen_sink.ExecuteActivityAction.heartbeat_timeout:type_name -> google.protobuf.Duration
	57,  // 60: temporal.omes.kitchen_sink.ExecuteActivityAction.retry_policy:type_name -> temporal.api.common.v1.RetryPolicy
	55,  // 61: temporal.omes.kitchen_sink.ExecuteActivityAction.is_local:type_name -> google.protobuf.Empty
	...
	58,  // 64: temporal.omes.kitchen_sink.ExecuteActivityAction.priority:type_name -> temporal.api.common.v1.Priority
	56,  // 65: temporal.omes.kitchen_sink.ExecuteChildWorkflowAction.input:type_name -> temporal.api.common.v1.Payload
	53,  // 66: temporal.omes.kitchen_sink.ExecuteChildWorkflowAction.workflow_execution_timeout:type_name -> google.protobuf.Duration
	53,  // 67: temporal.omes.kitchen_sink.ExecuteChildWorkflowAction.workflow_run_timeout:type_name -> google.protobuf.Duration
	53,  // 68: temporal.omes.kitchen_sink.ExecuteChildWorkflowAction.workflow_task_timeout:type_name -> google.protobuf.Duration
	...
	59,  // 70: temporal.omes.kitchen_sink.ExecuteChildWorkflowAction.workflow_id_reuse_policy:type_name -> temporal.api.enums.v1.WorkflowIdReusePolicy
	57,  // 71: temporal.omes.kitchen_sink.ExecuteChildWorkflowAction.retry_policy:type_name -> temporal.api.common.v1.RetryPolicy
	44,  // 72: temporal.omes.kitchen_sink.ExecuteChildWorkflowAction.headers:type_name -> temporal.omes.kitchen_sink.ExecuteChildWorkflowAction.HeadersEntry
	45,  // 73: temporal.omes.kitchen_sink.ExecuteChildWorkflowAction.memo:type_name -> temporal.omes.kitchen_sink.ExecuteChildWorkflowAction.MemoEntry
	46,  // 74: temporal.omes.kitchen_sink.ExecuteChildWorkflowAction.search_attributes:type_name -> temporal.omes.kitchen_sink.ExecuteChildWorkflowAction.SearchAttributesEntry
	...
	56,  // 78: temporal.omes.kitchen_sink.SendSignalAction.args:type_name -> temporal.api.common.v1.Payload
	47,  // 79: temporal.omes.kitchen_sink.SendSignalAction.headers:type_name -> temporal.omes.kitchen_sink.SendSignalAction.HeadersEntry
	...
	48,  // 82: temporal.omes.kitchen_sink.UpsertSearchAttributesAction.search_attributes:type_name -> temporal.omes.kitchen_sink.UpsertSearchAttributesAction.SearchAttributesEntry
	60,  // 83: temporal.omes.kitchen_sink.UpsertMemoAction.upserted_memo:type_name -> temporal.api.common.v1.Memo
	56,  // 84: temporal.omes.kitchen_sink.ReturnResultAction.return_this:type_name -> temporal.api.common.v1.Payload
	61,  // 85: temporal.omes.kitchen_sink.ReturnErrorAction.failure:type_name -> temporal.api.failure.v1.Failure
	56,  // 86: temporal.omes.kitchen_sink.ContinueAsNewAction.arguments:type_name -> temporal.api.common.v1.Payload
	53,  // 87: temporal.omes.kitchen_sink.ContinueAsNewAction.workflow_run_timeout:type_name -> google.protobuf.Duration
	53,  // 88: temporal.omes.kitchen_sink.ContinueAsNewAction.workflow_task_timeout:type_name -> google.protobuf.Duration
	49,  // 89: temporal.omes.kitchen_sink.ContinueAsNewAction.memo:type_name -> temporal.omes.kitchen_sink.ContinueAsNewAction.MemoEntry
	50,  // 90: temporal.omes.kitchen_sink.ContinueAsNewAction.headers:type_name -> temporal.omes.kitchen_sink.ContinueAsNewAction.HeadersEntry
	51,  // 91: temporal.omes.kitchen_sink.ContinueAsNewAction.search_attributes:type_name -> temporal.omes.kitchen_sink.ContinueAsNewAction.SearchAttributesEntry
	57,  // 92: temporal.omes.kitchen_sink.ContinueAsNewAction.retry_policy:type_name -> temporal.api.common.v1.RetryPolicy
	...
	52,  // 96: temporal.omes.kitchen_sink.ExecuteNexusOperation.headers:type_name -> temporal.omes.kitchen_sink.ExecuteNexusOperation.HeadersEntry
	...
	16,  // 98: temporal.omes.kitchen_sink.DoSignal.DoSignalActions.do_actions:type_name -> temporal.omes.kitchen_sink.ActionSet
	16,  // 99: temporal.omes.kitchen_sink.DoSignal.DoSignalActions.do_actions_in_main:type_name -> temporal.omes.kitchen_sink.ActionSet
	56,  // 100: temporal.omes.kitchen_sink.ExecuteActivityAction.GenericActivity.arguments:type_name -> temporal.api.common.v1.Payload
	53,  // 101: temporal.omes.kitchen_sink.ExecuteActivityAction.ResourcesActivity.run_for:type_name -> google.protobuf.Duration
	5,   // 102: temporal.omes.kitchen_sink.ExecuteActivityAction.ClientActivity.client_sequence:type_name -> temporal.omes.kitchen_sink.ClientSequence
	53,  // 103: temporal.omes.kitchen_sink.ExecuteActivityAction.TimeoutActivity.success_duration:type_name -> google.protobuf.Duration
	53,  // 104: temporal.omes.kitchen_sink.ExecuteActivityAction.TimeoutActivity.failure_duration:type_name -> google.protobuf.Duration
	53,  // 105: temporal.omes.kitchen_sink.ExecuteActivityAction.HeartbeatTimeoutActivity.success_duration:type_name -> google.protobuf.Duration
	53,  // 106: temporal.omes.kitchen_sink.ExecuteActivityAction.HeartbeatTimeoutActivity.failure_duration:type_name -> google.protobuf.Duration
	56,  // 107: temporal.omes.kitchen_sink.ExecuteActivityAction.HeadersEntry.value:type_name -> temporal.api.common.v1.Payload
	56,  // 108: temporal.omes.kitchen_sink.ExecuteChildWorkflowAction.HeadersEntry.value:type_name -> temporal.api.common.v1.Payload
	56,  // 109: temporal.omes.kitchen_sink.ExecuteChildWorkflowAction.MemoEntry.value:type_name -> temporal.api.common.v1.Payload
	56,  // 110: temporal.omes.kitchen_sink.ExecuteChildWorkflowAction.SearchAttributesEntry.value:type_name -> temporal.api.common.v1.Payload
	56,  // 111: temporal.omes.kitchen_sink.SendSignalAction.HeadersEntry.value:type_name -> temporal.api.common.v1.Payload
	56,  // 112: temporal.omes.kitchen_sink.UpsertSearchAttributesAction.SearchAttributesEntry.value:type_name -> temporal.api.common.v1.Payload
	56,  // 113: temporal.omes.kitchen_sink.ContinueAsNewAction.MemoEntry.value:type_name -> temporal.api.common.v1.Payload
	56,  // 114: temporal.omes.kitchen_sink.ContinueAsNewAction.HeadersEntry.value:type_name -> temporal.api.common.v1.Payload
	56,  // 115: temporal.omes.kitchen_sink.ContinueAsNewAction.SearchAttributesEntry.value:type_name -> temporal.api.common.v1.Payload
...
func file_kitchen_sink_proto_init() {
	...
	file_kitchen_sink_proto_msgTypes[13].OneofWrappers = []any{
		(*Action_Timer)(nil),
	...
	file_kitchen_sink_proto_msgTypes[14].OneofWrappers = []any{
	...
	file_kitchen_sink_proto_msgTypes[16].OneofWrappers = []any{
		...
		(*ExecuteActivityAction_Standalone)(nil),
		(*ExecuteActivityAction_IsLocal)(nil),
		(*ExecuteActivityAction_Remote)(nil),
	}
	file_kitchen_sink_proto_msgTypes[29].OneofWrappers = []any{
