...
const file_kitchen_sink_proto_rawDesc = "" +
	...
	"\x11nested_action_set\x18\x0e \x01(\v2%.temporal.omes.kitchen_sink.ActionSetH\x00R\x0fnestedActionSetB\t\n" +
	"\avariant\"\xf7\x02\n" +
	...
	"\x10awaitable_choice\x18\x02 \x01(\v2+.temporal.omes.kitchen_sink.AwaitableChoiceR\x0fawaitableChoice\"\xe4\f\n" +
	...
	"\tresources\x18\x0e \x01(\v2C.temporal.omes.kitchen_sink.ExecuteActivityAction.ResourcesActivityH\x00R\tresources\x12\x1d\n" +
	"\n" +
	...
	"\x10cpu_yield_for_ms\x18\x04 \x01(\rR\rcpuYieldForMs\x1a[\n" +
	...
	"\x11versioning_intent\x18\x03 \x01(\x0e2,.temporal.omes.kitchen_sink.VersioningIntentR\x10versioningIntent*\xa4\x01\n" +
...
func file_kitchen_sink_proto_init() {
	...
	file_kitchen_sink_proto_msgTypes[28].OneofWrappers = []any{
