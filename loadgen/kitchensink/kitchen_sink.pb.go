...
type ExecuteNexusOperation struct {
	...
	HandlerWorkflowInput *WorkflowInput `protobuf:"bytes,7,opt,name=handler_workflow_input,json=handlerWorkflowInput,proto3" json:"handler_workflow_input,omitempty"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
func (x *ExecuteNexusOperation) GetHandlerWorkflowInput() *WorkflowInput {
	if x != nil {
		return x.HandlerWorkflowInput
	}
	return nil
}
...
const file_kitchen_sink_proto_rawDesc = "" +
	...
	"\x10awaitable_choice\x18\x02 \x01(\v2+.temporal.omes.kitchen_sink.AwaitableChoiceR\x0fawaitableChoice\"\xfd\x15\n" +
	...
	"\theartbeat\x18\x16 \x01(\v2J.temporal.omes.kitchen_sink.ExecuteActivityAction.HeartbeatTimeoutActivityH\x00R\theartbeat\x12\x1d\n" +
	"\n" +
	...
	"\rfail_attempts\x18\x01 \x01(\x05R\ffailAttempts\x12D\n" +
	"\x10success_duration\x18\x02 \x01(\v2\x19.google.protobuf.DurationR\x0fsuccessDuration\x12D\n" +
	"\x10failure_duration\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\x0ffailureDuration\x1a[\n" +
	...
	"\x11versioning_intent\x18\x03 \x01(\x0e2,.temporal.omes.kitchen_sink.VersioningIntentR\x10versioningIntent\"\xdf\x03\n" +
	...
	"\x0fexpected_output\x18\x06 \x01(\tR\x0eexpectedOutput\x12_\n" +
	"\x16handler_workflow_input\x18\a \x01(\v2).temporal.omes.kitchen_sink.WorkflowInputR\x14handlerWorkflowInput\x1a:\n" +
	"\fHeadersEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
...
var file_kitchen_sink_proto_depIdxs = []int32{
	...
	15,  // 97: temporal.omes.kitchen_sink.ExecuteNexusOperation.handler_workflow_input:type_name -> temporal.omes.kitchen_sink.WorkflowInput
	...
	55,  // 100: temporal.omes.kitchen_sink.ExecuteActivityAction.GenericActivity.arguments:type_name -> temporal.api.common.v1.Payload
	52,  // 101: temporal.omes.kitchen_sink.ExecuteActivityAction.ResourcesActivity.run_for:type_name -> google.protobuf.Duration
	...
	52,  // 103: temporal.omes.kitchen_sink.ExecuteActivityAction.TimeoutActivity.success_duration:type_name -> google.protobuf.Duration
	52,  // 104: temporal.omes.kitchen_sink.ExecuteActivityAction.TimeoutActivity.failure_duration:type_name -> google.protobuf.Duration
	52,  // 105: temporal.omes.kitchen_sink.ExecuteActivityAction.HeartbeatTimeoutActivity.success_duration:type_name -> google.protobuf.Duration
	52,  // 106: temporal.omes.kitchen_sink.ExecuteActivityAction.HeartbeatTimeoutActivity.failure_duration:type_name -> google.protobuf.Duration
	55,  // 107: temporal.omes.kitchen_sink.ExecuteActivityAction.HeadersEntry.value:type_name -> temporal.api.common.v1.Payload
	55,  // 108: temporal.omes.kitchen_sink.ExecuteChildWorkflowAction.HeadersEntry.value:type_name -> temporal.api.common.v1.Payload
	55,  // 109: temporal.omes.kitchen_sink.ExecuteChildWorkflowAction.MemoEntry.value:type_name -> temporal.api.common.v1.Payload
	55,  // 110: temporal.omes.kitchen_sink.ExecuteChildWorkflowAction.SearchAttributesEntry.value:type_name -> temporal.api.common.v1.Payload
	55,  // 111: temporal.omes.kitchen_sink.SendSignalAction.HeadersEntry.value:type_name -> temporal.api.common.v1.Payload
	55,  // 112: temporal.omes.kitchen_sink.UpsertSearchAttributesAction.SearchAttributesEntry.value:type_name -> temporal.api.common.v1.Payload
	55,  // 113: temporal.omes.kitchen_sink.ContinueAsNewAction.MemoEntry.value:type_name -> temporal.api.common.v1.Payload
	55,  // 114: temporal.omes.kitchen_sink.ContinueAsNewAction.HeadersEntry.value:type_name -> temporal.api.common.v1.Payload
	55,  // 115: temporal.omes.kitchen_sink.ContinueAsNewAction.SearchAttributesEntry.value:type_name -> temporal.api.common.v1.Payload
