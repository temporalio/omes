...
const file_kitchen_sink_proto_rawDesc = "" +
	...
	"\x06jitter\x18\x02 \x01(\v2\x19.google.protobuf.DurationR\x06jitter\"\xe5\x02\n" +
	"\x0eScheduleAction\x12\x1f\n" +
	"\vworkflow_id\x18\x01 \x01(\tR\n" +
	"workflowId\x12#\n" +
	"\rworkflow_type\x18\x02 \x01(\tR\fworkflowType\x12\x1d\n" +
	"\n" +
	"task_queue\x18\x03 \x01(\tR\ttaskQueue\x12W\n" +
	"\x1aworkflow_execution_timeout\x18\x04 \x01(\v2\x19.google.protobuf.DurationR\x18workflowExecutionTimeout\x12M\n" +
	"\x15workflow_task_timeout\x18\x05 \x01(\v2\x19.google.protobuf.DurationR\x13workflowTaskTimeout\x12F\n" +
	"\fretry_policy\x18\x06 \x01(\v2#.temporal.api.common.v1.RetryPolicyR\vretryPolicy\"\xb2\x01\n" +
