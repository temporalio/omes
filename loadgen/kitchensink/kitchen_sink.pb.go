...
type ExecuteActivityAction_ResourcesActivity struct {
	...
	BytesToAllocate          uint64 `protobuf:"varint,1,opt,name=bytes_to_allocate,json=bytesToAllocate,proto3" json:"bytes_to_allocate,omitempty"`
	CpuYieldEveryNIterations uint32 `protobuf:"varint,2,opt,name=cpu_yield_every_n_iterations,json=cpuYieldEveryNIterations,proto3" json:"cpu_yield_every_n_iterations,omitempty"`
	CpuYieldForMs            uint32 `protobuf:"varint,3,opt,name=cpu_yield_for_ms,json=cpuYieldForMs,proto3" json:"cpu_yield_for_ms,omitempty"`
}
...
var file_kitchen_sink_proto_rawDesc = []byte{
	...
	0x62, 0x6c, 0x65, 0x43, 0x68, 0x6f, 0x69, 0x63, 0x65, 0x22, 0xa6, 0x0b, 0x0a, 0x15, 0x45, 0x78,
	...
	0x61, 0x64, 0x52, 0x09, 0x61, 0x72, 0x67, 0x75, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x1a, 0xa8, 0x01,
	0x0a, 0x11, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x41, 0x63, 0x74, 0x69, 0x76,
	0x69, 0x74, 0x79, 0x12, 0x2a, 0x0a, 0x11, 0x62, 0x79, 0x74, 0x65, 0x73, 0x5f, 0x74, 0x6f, 0x5f,
	0x61, 0x6c, 0x6c, 0x6f, 0x63, 0x61, 0x74, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0f,
	...
	0x02, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x18, 0x63, 0x70, 0x75, 0x59, 0x69, 0x65, 0x6c, 0x64, 0x45,
	...
	0x5f, 0x6d, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0d, 0x63, 0x70, 0x75, 0x59, 0x69,
...
var file_kitchen_sink_proto_depIdxs = []int32{
	...
	47, // 88: temporal.omes.kitchen_sink.ExecuteActivityAction.HeadersEntry.value:type_name -> temporal.api.common.v1.Payload
	47, // 89: temporal.omes.kitchen_sink.ExecuteChildWorkflowAction.HeadersEntry.value:type_name -> temporal.api.common.v1.Payload
	47, // 90: temporal.omes.kitchen_sink.ExecuteChildWorkflowAction.MemoEntry.value:type_name -> temporal.api.common.v1.Payload
	47, // 91: temporal.omes.kitchen_sink.ExecuteChildWorkflowAction.SearchAttributesEntry.value:type_name -> temporal.api.common.v1.Payload
	47, // 92: temporal.omes.kitchen_sink.SendSignalAction.HeadersEntry.value:type_name -> temporal.api.common.v1.Payload
	47, // 93: temporal.omes.kitchen_sink.UpsertSearchAttributesAction.SearchAttributesEntry.value:type_name -> temporal.api.common.v1.Payload
	47, // 94: temporal.omes.kitchen_sink.ContinueAsNewAction.MemoEntry.value:type_name -> temporal.api.common.v1.Payload
	47, // 95: temporal.omes.kitchen_sink.ContinueAsNewAction.HeadersEntry.value:type_name -> temporal.api.common.v1.Payload
	47, // 96: temporal.omes.kitchen_sink.ContinueAsNewAction.SearchAttributesEntry.value:type_name -> temporal.api.common.v1.Payload
