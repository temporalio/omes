...
func (x *ClientAction) GetDoSelfDescribe() *DoSelfDescribe {
	if x != nil {
		if x, ok := x.Variant.(*ClientAction_DoSelfDescribe); ok {
...
type DoSelfDescribe struct {
	...
	DoSelfDescribe bool `protobuf:"varint,1,opt,name=do_self_describe,json=doSelfDescribe,proto3" json:"do_self_describe,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *DoSelfDescribe) GetDoSelfDescribe() bool {
	if x != nil {
		return x.DoSelfDescribe
	}
	return false
...
const file_kitchen_sink_proto_rawDesc = "" +
	...
	"\tdo_update\x18\x03 \x01(\v2$.temporal.omes.kitchen_sink.DoUpdateH\x00R\bdoUpdate\x12V\n" +
	"\x10do_self_describe\x18\x04 \x01(\v2*.temporal.omes.kitchen_sink.DoSelfDescribeH\x00R\x0edoSelfDescribe\x12T\n" +
	"\x0enested_actions\x18\x05 \x01(\v2+.temporal.omes.kitchen_sink.ClientActionSetH\x00R\rnestedActionsB\t\n" +
	"\avariant\"\x9e\x03\n" +
	"\bDoSignal\x12b\n" +
	...
	"\x04args\x18\x02 \x03(\v2\x1f.temporal.api.common.v1.PayloadR\x04args\":\n" +
	"\x0eDoSelfDescribe\x12(\n" +
	"\x10do_self_describe\x18\x01 \x01(\bR\x0edoSelfDescribe\"\x8d\x01\n" +
	"\rWorkflowState\x12D\n" +
...
func file_kitchen_sink_proto_init() {
	...
	file_kitchen_sink_proto_msgTypes[15].OneofWrappers = []any{
	...
	file_kitchen_sink_proto_msgTypes[17].OneofWrappers = []any{
	...
	file_kitchen_sink_proto_msgTypes[30].OneofWrappers = []any{
