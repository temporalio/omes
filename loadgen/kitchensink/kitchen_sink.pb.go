...
const file_kitchen_sink_proto_rawDesc = "" +
	...
	"\x10awaitable_choice\x18\x02 \x01(\v2+.temporal.omes.kitchen_sink.AwaitableChoiceR\x0fawaitableChoice\"\xc6\f\n" +
	...
	"\vPriorityKey\x18\x0f \x01(\x05R\vPriorityKey\x12 \n" +
	"\vFairnessKey\x18\x10 \x01(\tR\vFairnessKey\x12&\n" +
	"\x0eFairnessWeight\x18\x11 \x01(\x02R\x0eFairnessWeight\x1ad\n" +
