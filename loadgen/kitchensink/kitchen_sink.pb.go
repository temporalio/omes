...
type ExecuteActivityAction struct {
	...
	PriorityKey    int32   `protobuf:"varint,15,opt,name=PriorityKey,proto3" json:"PriorityKey,omitempty"`
...
func (x *ExecuteActivityAction) GetPriorityKey() int32 {
	if x != nil {
...
var file_kitchen_sink_proto_rawDesc = []byte{
	...
	0x65, 0x79, 0x18, 0x0f, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0b, 0x50, 0x72, 0x69, 0x6f, 0x72, 0x69,
