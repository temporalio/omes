...
class ExecuteNexusOperation(_message.Message):
    __slots__ = ("endpoint", "operation", "input", "headers", "awaitable_choice", "expected_output", "handler_workflow_input")
    class HeadersEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
    ...
    HANDLER_WORKFLOW_INPUT_FIELD_NUMBER: _ClassVar[int]
    endpoint: str
    operation: str
    input: str
    ...
    awaitable_choice: AwaitableChoice
    expected_output: str
    handler_workflow_input: WorkflowInput
    def __init__(self, endpoint: _Optional[str] = ..., operation: _Optional[str] = ..., input: _Optional[str] = ..., headers: _Optional[_Mapping[str, str]] = ..., awaitable_choice: _Optional[_Union[AwaitableChoice, _Mapping]] = ..., expected_output: _Optional[str] = ..., handler_workflow_input: _Optional[_Union[WorkflowInput, _Mapping]] = ...) -> None: ...
