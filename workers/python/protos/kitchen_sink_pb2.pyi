...
class ClientAction(_message.Message):
    __slots__ = ("do_signal", "do_query", "do_update", "nested_actions", "do_describe", "do_standalone_activity", "do_create_schedule")
    DO_SIGNAL_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, do_signal: _Optional[_Union[DoSignal, _Mapping]] = ..., do_query: _Optional[_Union[DoQuery, _Mapping]] = ..., do_update: _Optional[_Union[DoUpdate, _Mapping]] = ..., nested_actions: _Optional[_Union[ClientActionSet, _Mapping]] = ..., do_describe: _Optional[_Union[DoDescribe, _Mapping]] = ..., do_standalone_activity: _Optional[_Union[DoStandaloneActivity, _Mapping]] = ..., do_create_schedule: _Optional[_Union[DoCreateSchedule, _Mapping]] = ...) -> None: ...
