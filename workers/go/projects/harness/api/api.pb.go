...
type InitRequest struct {
	...
	RegisterSearchAttributes bool `protobuf:"varint,6,opt,name=register_search_attributes,json=registerSearchAttributes,proto3" json:"register_search_attributes,omitempty"`
	unknownFields            protoimpl.UnknownFields
	sizeCache                protoimpl.SizeCache
}
...
func (x *InitRequest) GetRegisterSearchAttributes() bool {
	if x != nil {
		return x.RegisterSearchAttributes
	}
	return false
}
