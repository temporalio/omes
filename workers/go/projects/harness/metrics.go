// This file is a standalone implementation of client.MetricsHandler backed by
// Prometheus. It duplicates the implementation in metrics/metrics.go because the
// project harness is a separate Go module — importing metrics/ would pull in the
// full omes dependency tree and lock project tests to the main module's SDK version.
// Project tests need to pin their own SDK versions independently.
