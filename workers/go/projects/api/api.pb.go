// Protocol for the project test framework.
//
// Each project test compiles into a single binary with two subcommands:
//   - "worker": connects to Temporal and polls for tasks
//   - "project-server": runs a gRPC server implementing ProjectService
//
// The omes CLI orchestrates the test by:
//   1. Starting the worker (separate process or container)
//   2. Starting the project-server
//   3. Sending Init (creates client, optional project setup like Nexus endpoints)
//   4. Sending Execute for each iteration (starts workflows, verifies results)
...
const file_api_proto_rawDesc = "" +
	...
	"\aExecute\x12).temporal.omes.projects.v1.ExecuteRequest\x1a*.temporal.omes.projects.v1.ExecuteResponse\"\x00B4Z2github.com/temporalio/omes/workers/go/projects/apib\x06proto3"
