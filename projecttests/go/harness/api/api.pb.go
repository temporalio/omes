...
type InitRequest struct {
	...
	Config                   []byte                 `protobuf:"bytes,5,opt,name=config,proto3" json:"config,omitempty"` // opaque project config (JSON)
...
type ExecuteRequest struct {
	...
	Payload       []byte                 `protobuf:"bytes,2,opt,name=payload,proto3" json:"payload,omitempty"` // opaque per-iteration data
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_api_proto_rawDesc = "" +
	"\n" +
	"\tapi.proto\x12\x1dtemporal.omes.projecttests.v1\"\xbf\x02\n" +
	...
	"\x19disable_host_verification\x18\b \x01(\bR\x17disableHostVerification\"\x94\x02\n" +
	"\vInitRequest\x12!\n" +
	"\fexecution_id\x18\x01 \x01(\tR\vexecutionId\x12\x15\n" +
	"\x06run_id\x18\x02 \x01(\tR\x05runId\x12\x1d\n" +
	"\n" +
	"task_queue\x18\x03 \x01(\tR\ttaskQueue\x12V\n" +
	"\x0fconnect_options\x18\x04 \x01(\v2-.temporal.omes.projecttests.v1.ConnectOptionsR\x0econnectOptions\x12\x16\n" +
	...
	"\x0fExecuteResponse2\xdf\x01\n" +
	"\x0eProjectService\x12a\n" +
	"\x04Init\x12*.temporal.omes.projecttests.v1.InitRequest\x1a+.temporal.omes.projecttests.v1.InitResponse\"\x00\x12j\n" +
	"\aExecute\x12-.temporal.omes.projecttests.v1.ExecuteRequest\x1a..temporal.omes.projecttests.v1.ExecuteResponse\"\x00B-Z+github.com/temporalio/omes/projecttests/apib\x06proto3"
...
var file_api_proto_goTypes = []any{
	(*ConnectOptions)(nil),  // 0: temporal.omes.projecttests.v1.ConnectOptions
	(*InitRequest)(nil),     // 1: temporal.omes.projecttests.v1.InitRequest
	(*InitResponse)(nil),    // 2: temporal.omes.projecttests.v1.InitResponse
	(*ExecuteRequest)(nil),  // 3: temporal.omes.projecttests.v1.ExecuteRequest
	(*ExecuteResponse)(nil), // 4: temporal.omes.projecttests.v1.ExecuteResponse
}
var file_api_proto_depIdxs = []int32{
	0, // 0: temporal.omes.projecttests.v1.InitRequest.connect_options:type_name -> temporal.omes.projecttests.v1.ConnectOptions
	1, // 1: temporal.omes.projecttests.v1.ProjectService.Init:input_type -> temporal.omes.projecttests.v1.InitRequest
	3, // 2: temporal.omes.projecttests.v1.ProjectService.Execute:input_type -> temporal.omes.projecttests.v1.ExecuteRequest
	2, // 3: temporal.omes.projecttests.v1.ProjectService.Init:output_type -> temporal.omes.projecttests.v1.InitResponse
	4, // 4: temporal.omes.projecttests.v1.ProjectService.Execute:output_type -> temporal.omes.projecttests.v1.ExecuteResponse
