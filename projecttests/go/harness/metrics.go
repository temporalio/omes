...
// promMetricsState and promMetricsHandler are a standalone implementation of
// client.MetricsHandler. The harness is a separate Go module and cannot import
// the main metrics package, so we duplicate the Prometheus adapter here.
