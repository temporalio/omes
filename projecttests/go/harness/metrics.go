...
// promMetricsState and promMetricsHandler implement client.MetricsHandler.
// This is a standalone duplicate of the implementation in metrics/metrics.go.
// The harness is intended to act as a separate Go module, standalone from the Omes CLI.
