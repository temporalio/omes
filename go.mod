...
require (
	...
	github.com/temporalio/omes/workers/go/projects/api v0.0.0-00010101000000-000000000000
...
replace (
	...
	github.com/temporalio/omes/workers/go/projects/api => ./workers/go/projects/api
)
